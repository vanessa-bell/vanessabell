    ...
    <form onSubmit={handleSubmit} className="space-y-3">
      ...
      <div className="grid sm:grid-cols-2 gap-3">
        <div>
          ...
          <input
            ...
            required
            autoComplete="name"
            className="w-full px-3.5 py-2.5 rounded-lg border border-warm-gray/25 dark:border-dark-warm-gray/25 bg-cream dark:bg-dark-surface text-charcoal dark:text-dark-cream text-sm focus:outline-none focus:ring-2 focus:ring-clay/40 dark:focus:ring-dark-clay/40 transition-shadow"
          />
        </div>
        <div>
      ...
      <div>
        ...
        <textarea
          ...
          name="message"
          rows={3}
          className="w-full px-3.5 py-2.5 rounded-lg border border-warm-gray/25 dark:border-dark-warm-gray/25 bg-cream dark:bg-dark-surface text-charcoal dark:text-dark-cream text-sm focus:outline-none focus:ring-2 focus:ring-clay/40 dark:focus:ring-dark-clay/40 transition-shadow resize-none"
        />
      </div>
      {status === "error" && (
